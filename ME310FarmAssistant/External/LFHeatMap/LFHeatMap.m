    ...
    for (int y = 0; y < height; y++)
    {
        for (int x = 0; x < width; x++, i++)
        {
            if (density[i] > 0)
            {
                ...
                a = 0.85 * 255;
                if (floatDensity < 0.125) {
                    r = 50;
                    g = 136;
                    b = 189;
                } else if (floatDensity < 0.250) {
                    r = 102;
                    g = 194;
                    b = 165;
                } else if (floatDensity < 0.375) {
                    r = 171;
                    g = 221;
                    b = 164;
                } else if (floatDensity < 0.500) {
                    r = 230;
                    g = 245;
                    b = 152;
                } else if (floatDensity < 0.625) {
                    r = 254;
                    g = 224;
                    b = 139;
                } else if (floatDensity < 0.750) {
                    r = 253;
                    g = 174;
                    b = 97;
                } else if (floatDensity < 0.875) {
                    r = 244;
                    g = 109;
                    b = 67;
                } else {
                ...
                rgba[indexOrigin] = r;
                rgba[indexOrigin+1] = g;
                rgba[indexOrigin+2] = b;
                rgba[indexOrigin+3] = a;
            }
        }
    }
